            ...
            <div className="flex justify-center items-center w-screen bg-white">
                ...
                <div className="container mx-auto my-4 px-4 lg:px-20">
                    <div className="w-full p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
                        <div className="flex">
                            <h1 className="font-bold uppercase text-5xl font-WorkSans">
                        ...
                        <div className="my-2 w-1/2 lg:w-1/4">
                            <button
                                className="uppercase text-sm tracking-wide bg-black text-gray-100 p-3 rounded-lg w-full 
                  focus:outline-none focus:shadow-outline font-Urbanist"
                            >
                                Send Message
                            </button>
                        </div>
                    ...
                    <div className="w-full lg:-mt-96 lg:w-2/6 px-8 py-12 ml-auto bg-black rounded-2xl">
                        <div className="flex flex-col text-white">
                            <h1 className="font-bold uppercase text-4xl my-4 font-Roboto">
                                Drop in our office
                            </h1>
                            ...
                            <div className="flex my-4 w-2/3 lg:w-1/2">
                                ...
                                <i className="fas fa-map-marker-alt pt-2 pr-2">
                                    <div className="flex flex-col">
                                        <h2 className="text-2xl font-Roboto">Main Office</h2>
                                        <p className="text-gray-400 font-Roboto">
