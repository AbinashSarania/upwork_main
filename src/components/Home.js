        ...
        <div>
            ...
            <div>
                <div className="flex flex-col md:flex-row justify-center mt-32 mb-32">
                    <div className="grid grid-cols-1 gap-0 mx-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3">
                        {posts.map((item, key) => (
                            <div className={`w-full lg:max-w-xs ${item.className}`} key={key}>
                                <div className="p-4">
                                    <h4 className={`text-2xl font-semibold text-black text-center h-0 mb-8 ${key === 0 ? 'font-bold font-WorkSans text-xl mt-8 mb-6' : ''}`}>
                                        {item.title}
                                    </h4>
                                </div>
                                {item.isTextOnly ? (
                                    <p className={` text-black text-center h-0 mb-8 ${key === 0 ? ' font-WorkSans text-sm mx-2 mt-8 mb-8' : ''}`}>
                                        {item.content}
                                    </p>
                                ) : (
                                ...
                                {!item.isTextOnly && (
                                    <p className={`p-4 text-center sm:text-sm sm:leading-snug md:leading-relaxed lg:leading-relaxed max-w-xs mx-auto ${key === 0 ? 'text-lg mt-2 mb-8' : ''}`}>
                                        {item.content}
                                    </p>
                                )}
                            </div>
